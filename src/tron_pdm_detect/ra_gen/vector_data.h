...
#define VECTOR_NUMBER_PDM_SDET ((IRQn_Type) 6) /* PDM SDET (Sound detection interrupt) */
#define PDM_SDET_IRQn          ((IRQn_Type) 6) /* PDM SDET (Sound detection interrupt) */
#define VECTOR_NUMBER_PDM_ERR2 ((IRQn_Type) 7) /* PDM ERR2 (Error detection interrupt channel 2) */
#define PDM_ERR2_IRQn          ((IRQn_Type) 7) /* PDM ERR2 (Error detection interrupt channel 2) */
