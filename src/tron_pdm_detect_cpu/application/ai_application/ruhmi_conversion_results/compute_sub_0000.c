...
void compute_sub_0000(
  ...
  int8_t sequential_conv1d_Conv1D_ExpandDims1_70011[650]  // 1,1,50,13
...
memcpy(sequential_conv1d_Conv1D_ExpandDims1_70011, serving_default_x_0, 650 * sizeof(int8_t));
