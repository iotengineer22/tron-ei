...
// NPU driver config disabled for CPU version
...
LOCAL void task_3(INT stacd, void *exinf)
{
    ...
    tm_printf((UB *)"=== Starting CPU Voice Detection Task (task_3)... ===\n");
    tm_printf((UB *)"SUCCESS: CPU Voice Detection Task initialized successfully!\n");
